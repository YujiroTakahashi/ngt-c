...
int main(int argc, char **argv)
{
    ...
    {
        std::ifstream istrm("index/obj.dat", std::ios::binary);
        std::string input(
    ...
    {
        std::ifstream istrm("index/dist.dat", std::ios::binary);
        std::string input(
            (std::istreambuf_iterator<char>(istrm)), 
            std::istreambuf_iterator<char>()
        );
    ...
    {
        std::ifstream istrm("index/leaf.dat", std::ios::binary);
        std::string input(
            (std::istreambuf_iterator<char>(istrm)), 
            std::istreambuf_iterator<char>()
        );
    ...
    {
        std::ifstream istrm("index/internal.dat", std::ios::binary);
        std::string input(
            (std::istreambuf_iterator<char>(istrm)), 
            std::istreambuf_iterator<char>()
        );
